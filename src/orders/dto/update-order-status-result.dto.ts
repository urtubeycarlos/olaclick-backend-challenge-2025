...
export class UpdateOrderStatusResultDTO {
    ...
    @ApiProperty({ example: 'delivered', description: 'Nuevo estado del pedido' })
    status: string;
    ...
    static fromEntity(entity: Order): UpdateOrderStatusResultDTO {
        const dto = new UpdateOrderStatusResultDTO();
